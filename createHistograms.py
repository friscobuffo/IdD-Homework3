...
array = np.array([key for key in rowsNumber2tablesQuantity for _ in range(rowsNumber2tablesQuantity[key])])
plt.hist(array, 80, (1,80))
plt.savefig("histograms/rowsNumber2tablesQuantity.jpg")
plt.clf()

array = np.array([key for key in distinctValuesNumber2columnsQuantity for _ in range(distinctValuesNumber2columnsQuantity[key])])
plt.hist(array, 80, (1,80))
